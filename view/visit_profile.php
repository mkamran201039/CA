...
<div class="container2">
        ...
        <div class="header2">
            <ul>
                <li><a href="#personal-info">Academic Info</a></li>
                <li><a href="#education">Achievements</a></li>
                <li><a href="#work-experience">Work Experience</a></li>
                <li><a href="#work-experience">Helping Area</a></li>
                <li style="border:0px"><a href="#skills" >Contact Info</a></li>
            </ul>
        </div>
        <div class="content">
            <br><br>
