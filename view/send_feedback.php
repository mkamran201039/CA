						...
						while ($row = mysqli_fetch_assoc($result)) {
						  ...
						  ?>
                            ...
                            <div class="form-group">
                              ...
                              <textarea id="m_feedback"  rows="5" cols="90"  name='feedback' placeholder="Give your feedback here"></textarea><br>
                            ...
                            <button type="submit"  name="submit" style="width:20%" onclick="showMessage()">Send feedback</button>
                          </form>
