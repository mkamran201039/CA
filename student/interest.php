<?php
   ...
   if(isset($_POST["submit"])){
    ...
    $sql="INSERT INTO `interest`(`id`, `academic/industry`) VALUES ('','$interest')";
...
<body>
    ...
    <span class="number">1</span> <span class="name" style="color: #000;">Basic Information</span>
        <span class="number">2</span> <span class="name">SKILLS</span>   <span class="number" style="color: #fff; background-color: #15ac31;">3</span> <span class="name">Interest</span> 
         <span class="number"  >4</span> <span class="name">Contact</span> 
         <span class="number"  >5</span> <span class="name">Job Status</span> 
    </div>

    <p style="text-align: center; margin-bottom: 0; color: #3983FA; font-size: 40px;">Interest</p>
        ...
        <form action="" method="POST">
            ...
            <div style="display: flex; gap: 20px;">
                ...
                <div style="display: flex; flex-direction: column;">
                    ...
                    height: 30px;border-radius:3px" type="text" name="interest" id="" required placeholder="Enter your required side industru/academic">
