		...
		<div class="right-box" >
						...
						while ($row = mysqli_fetch_assoc($result)) {
						  ...
						  ?>
                            ...
                            <form method="POST" action="../controller/feedback_save.php? id=<?php echo $id ?>& name=<?php echo $name ?> ">
                            <div class="form-group">
                              <label ><i><b>Your Feedback</b></i></label><br>
                              <textarea id="m_feedback" style="width:100%" rows="5" cols="90"  name='feedback' placeholder="Give your feedback here"></textarea><br>
                            ...
                            <button type="submit"  name="submit" onclick="showMessage()">Send feedback</button>
                          </form>
