...
function calculatePoints() {
		...
		{   document.getElementById("points").style.color="red";
			document.getElementById("points").innerHTML = "<h5><i>You scored " + points + " point(s) out of 13 , try to improve!</i> </h5>";
		}
        
		else
		{   
			document.getElementById("points").style.color="green";
			document.getElementById("points").innerHTML = "<h5>You scored " + points + " point(s) out of 13 ,  You are an excellent candidate!</h5> ";
		}
